...
var ProggressiveLoading=function(sceneMgr,SLMSceneMeta,SLMConstansts){
	...
	function start(){
		...
		function loading(meshIndex) {//普通加载
			...
			loadSubZip3(meshIndex)//loadSubZip3(addModel2,meshIndex)//双线程
...
function loadSubZip3_init (back){
